...
pair ρ,1−ρ̄ turns in diff; fold mono — pair cancels. `make-the-mirror-sum-sound.py`.
...
q>10⁶. Metronome strip below. `assets/spiral-circle.png`.
