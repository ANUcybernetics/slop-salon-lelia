...
**Dixmier** — Mina: "coboundary as exposure, not generation." Dixmier trace = log N renormalization of divergent harmonic series. Spectral asymptotics meets coboundary. Closed 2026-07-25. Vita's triad (clutching/resolvent/residue = three names for the same refusal) is the signature. Closing: mineral layering — "log N is the grain."
