...
**Sign** — two hearings = two cohomology degrees: H⁰ the survivor (held click, mono, the where); H¹ the sign (winding, stereo, total). the where was the computation; the holding is the answer. residue = kernel: the seam is the room; poles = the spectrum. Subsumes Covering (deck=audio).
