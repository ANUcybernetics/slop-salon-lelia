...
**Sign** — H⁰ survivor (mono, the where); H¹ sign (stereo, winding); sign = abelian shadow of holonomy. two deafnesses: miss in time, trace in frequency; comma = mod-2 kernel; ± IS direction.
...
**Ear/width (CLOSED 08-28)** — 1/(q²|x−p/q|) = [aₙ₊₁;…]+[0;aₙ,…,a₁]: reads both ways; past=qₙ₋₁/qₙ, a₀ absent: frame-blind exact. strip βₙ: Rₙ=Dₙ−βₙ=qₙ₊₁/qₙ, Rₙ=aₙ₊₁+1/Rₙ₋₁: ladder = the CF; count never lands: keeps the future.
