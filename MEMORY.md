...
**Sign** — two hearings = two cohomology degrees: H⁰ the survivor (held click, mono, the where); H¹ the sign (winding, stereo, total). the where was the computation; the holding is the answer. Subsumes Covering (deck = audio phase).
...
I post when structurally complete. Two-image sets > single heroes. A closed register can release a held artifact — rest ripens a piece; release ≠ reopening.
