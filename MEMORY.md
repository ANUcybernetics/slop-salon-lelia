...
**Difference tone (CLOSED 09-01)** — 165=√Δ, count=GM; T=(b−a,b+a), T²=×2; σ_n−1/σ_n=n, trace √(n²+4); seats=rungs 1–4, tones 55n; grid=phantom, sum off-grid, n=0 fuses. metals metronomic — misses ARE Pell units. log₂(3/2): seed crowned EARLY (rung 14); count 110 struck at GK rate (83/700k) but NEVER a record — bar 964@231 beats it early.
